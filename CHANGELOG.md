...
### Bug Fixes
* Nuke adaptor now detects and reports license failures with actionable BYOL/UBL guidance, instead of showing a generic "Nuke encountered an error and was not able to complete initialization actions" message. (#351)
