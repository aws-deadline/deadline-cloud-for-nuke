...
### Features
* Pre-GUI hooks are now run in the Nuke render submitter before building the submission dialog. Studios can use hooks from DEADLINE_HOOKS_DIR to pre-populate dialog fields such as job name, description, and parameters. (#321)
