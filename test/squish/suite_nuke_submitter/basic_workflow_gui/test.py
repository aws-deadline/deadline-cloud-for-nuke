...
def main():
    ...
    squish.setWindowState(squish.waitForObject(names.nukeMainWindow_Foundry_UI_DockMainWindow), squish.WindowState.Maximize)
    ...
    script_path = os.path.join(nuke_asset_path, "nuke_test_samples/nuke_submitter_v02_nuke_default_test_samples/scripts/nukeSubmitter_v02_nuke_default_one_write_node.nk")
