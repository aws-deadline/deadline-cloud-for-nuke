...
from deadline.nuke_submitter.update_utils import (
    _check_for_update,
    _session_state,
    check_and_show_update_dialog,
)

MODULE = "deadline.nuke_submitter.update_utils"
...
class TestCheckForUpdate:
    ...
    def test_passes_correct_integration_name(self, mock_check):
        ...
        assert call_kwargs["integration_name"] == "deadline-cloud-for-nuke"
