...
import pytest
from deadline.nuke_submitter.data_classes import SubmitterUISettings, RenderSettings, CopyCatTrainingSettings


class TestSubmitterUISettings:
    @pytest.mark.parametrize("job_type,settings_class,specific_settings", [
        ...
        ("copycat", CopyCatTrainingSettings, {
    ...
    @pytest.mark.parametrize("job_type,settings_class,sticky_data", [
        ("render", RenderSettings, {
            "name": "loaded_job",
