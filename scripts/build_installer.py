...
INSTALLER_FILENAMES = {
    "Windows": "DeadlineCloudForNukeSubmitter-windows-x64-installer.exe",
    "Linux": "DeadlineCloudForNukeSubmitter-linux-x64-installer.run",
    "MacOS": "DeadlineCloudForNukeSubmitter-osx-installer.app",
}
